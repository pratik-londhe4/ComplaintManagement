<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-dash.aspx.cs" Inherits="ComplaintManagement.index" %>
        ...
        <ul class="navbar-nav">
          <li class="logo">
            <a href="#" class="nav-link">
              <span class="link-text logo-text">Peoples Bank</span>
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fad"
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <span class="link-text">All Transactions </span>
            </a>
          </li>
          ...
          <div>
            ...
            <h3> Pie Chart</h3>
                    ...
                    <asp:Chart ID="Chart1" runat="server" DataSourceId="SqlDataSource1">
                        ...
                        <Titles>
                            <asp:Title BackColor="192, 192, 255" Font="Tahoma, 12pt" Name="Title1" Text="Acoounts According to Types">
                            </asp:Title>
                        </Titles>
                    </asp:Chart>
